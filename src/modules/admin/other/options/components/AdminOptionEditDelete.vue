  ...
  <div class="d-flex justify-content-center align-items-center">
    <div class="container">
      <div class="text-center pt-5 mt-5">
        <h4 class="text-spacing5">Option: {{ getAdminOptionData.selectedOptionData.video_option_id}}</h4>
      ...
      <div class="d-flex justify-content-center">
        <div class="col-sm-6 col-12 video-edit-card d-flex flex-column justify-content-center align-items-center">
          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex flex-column justify-content-center center pb-3 px-2">
              ...
              <div class="d-flex justify-content-center align-items-center">
                ...
                <div>
                  <input class="custom-input" v-model="getAdminOptionData.selectedOptionData.option_name"  placeholder="Option name" type="text">
                </div>
              </div>
            </div>
          ...
          <div class="d-flex justify-content-between align-items-center py-2">
            ...
            <div class="d-flex justify-content-between align-items center px-4">
              <div class="d-flex flex-column justify-content-center center">
                ...
                <div class="d-flex justify-content-center align-items-center">
                  <div>
                    <input class="dark-mode-button mt-2 mx-3" :value="null" v-model="getAdminOptionData.selectedOptionData.game_id"  type="radio" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="d-flex flex-column justify-content-center center">
              ...
              <div class="d-flex justify-content-center align-items-center">
                ...
                <div>
                  <select class="custom-select" v-model="getAdminOptionData.selectedOptionData.game_id">
          ...
          <div class="d-flex justify-content-between align-items-center py-2">
            ...
            <div class="d-flex justify-content-between align-items center px-4">
              <div class="d-flex flex-column justify-content-center center">
                ...
                <div class="d-flex justify-content-center align-items-center">
                  <div>
                    <input class="dark-mode-button mt-2 mx-3" :value="null" v-model="getAdminOptionData.selectedOptionData.video_id" type="radio" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="d-flex flex-column justify-content-center center">
              ...
              <div class="d-flex justify-content-center align-items-center">
                ...
                <div>
                  <select class="custom-select" v-model="getAdminOptionData.selectedOptionData.video_id">
          ...
          <info-modal
              id="optionEditModal"
              aria-hidden="true"
              :object-id="getAdminOptionData.selectedOptionData.video_option_id"
              :creation-date="getAdminOptionData.selectedOptionData.created_at"
              :update-date="getAdminOptionData.selectedOptionData.created_at"
          ></info-modal>
          ...
          <delete-modal
              ...
              :header-name="getAdminOptionData.selectedOptionData.option_name"
          ></delete-modal>
