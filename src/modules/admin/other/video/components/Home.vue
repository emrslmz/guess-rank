<template>
  <div class="level-home flex-column">
    ...
    <div class="text-center py-3">
      <h4 class="text-spacing5"><i class="fab fa-youtube"></i> Videos</h4>
      <small>Add/edit or delete videos.</small>
    </div>
    <div>
      <router-link to="/admin/other/video/all">
        <button class="button-valorant">
          <span class="btn-valorant-inner">
            ...
            <span class="btn-valorant-content"><i class="fas fa-box"></i> Added Video</span>
          </span>
        </button>
      </router-link>
    </div>
    ...
    <div>
      <router-link to="/admin/other/video/add">
        <button class="button-valorant btn-valorant-light">
          <span class="btn-valorant-inner">
            <span class="btn-valorant-slide"></span>
            <span class="btn-valorant-content"><i class="fas fa-plus"></i> Add Video</span>
          </span>
        </button>
      </router-link>
    </div>
