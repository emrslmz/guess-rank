<template>
  <div class="level-home flex-column">
    ...
    <div class="text-center py-3">
      <h4 class="text-spacing5"><i class="fas fa-square"></i> Option Groups</h4>
      <small>Add/edit or delete option Group.</small>
    </div>
    <div>
      <router-link to="/admin/other/option-group/all">
        <button class="button-valorant">
          <span class="btn-valorant-inner">
            <span class="btn-valorant-slide"></span>
            <span class="btn-valorant-content"><i class="fas fa-box"></i> Added Option Group</span>
          </span>
        </button>
      </router-link>
    </div>
    ...
    <div>
      <router-link to="/admin/other/option-group/add">
        <button class="button-valorant btn-valorant-light">
          <span class="btn-valorant-inner">
            <span class="btn-valorant-slide"></span>
            <span class="btn-valorant-content"><i class="fas fa-plus"></i> Add Option Group</span>
          </span>
        </button>
      </router-link>
    </div>
