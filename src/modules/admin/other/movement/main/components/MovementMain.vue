<template>
  <div class="level-home flex-column">
    ...
    <div class="text-center py-3">
      <h4 class="text-spacing5"><i class="fas fa-sign"></i> Movements</h4>
      <small>You can view / manage all your actions here</small>
    </div>
    <div>
      <router-link to="/admin/other/movement/user-video-view">
        <button class="button-valorant">
          <span class="btn-valorant-inner">
            <span class="btn-valorant-slide"></span>
            <span class="btn-valorant-content"><i class="far fa-eye"></i> User Video View Status</span>
          </span>
        </button>
      </router-link>
    </div>
    ...
    <div>
      <router-link to="/admin/other/movement/user-level">
        <button class="button-valorant btn-valorant-light">
          <span class="btn-valorant-inner">
            <span class="btn-valorant-slide"></span>
            <span class="btn-valorant-content"><i class="fas fa-star-half-alt"></i> User Level Status</span>
          </span>
        </button>
      </router-link>
    </div>
