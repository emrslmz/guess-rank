    ...
    <div style="padding-top: 150px"></div>
      <div class="d-xl-flex justify-content-between align-items-start">
        ...
        <div class="col-12 col-xl-4">
          <div class="login-card d-flex justify-content-center align-items-center" v-if="!registerCard">
            <div class="d-flex">
              <div class="col-12">
                ...
                <div class="d-flex justify-content-center align-items-center py-2">
                  ...
                  <input class="login-input" placeholder="Username" type="text" />
                </div>
                <div class="d-flex justify-content-center align-items-center py-2">
                  <div class="login-icon d-flex align-items-center">
                    <i class="fas fa-key"></i>
                  </div>
                  <input class="login-input" placeholder="Password" type="text" />
                </div>
                <div class="d-flex justify-content-center align-items-center">
                  <div class="d-xl-flex align-items-center">
                    <label class="checkbox-input text-left">
                      Remember me
                      <input type="checkbox" />
                      <span style="border-radius: 10px" class="checkmark"></span>
                    </label>
                  </div>
                </div>
                ...
                <div class="text-center">
                  ...
                  <div><small>I forgot my password</small></div>
                </div>
              </div>
            </div>
          </div>
          <div class="login-card d-flex justify-content-center align-items-center" v-else>
            <div class="d-flex">
              <div class="col-12">
                <div class="text-center">
                  <h5>What a pleasure to see you among us :)</h5>
                  <small>Let's register quickly!</small>
                </div>
                ...
                <div class="d-flex justify-content-center align-items-center py-2">
                  ...
                  <input class="register-input" placeholder="Your name, surname" type="text" />
                </div>
                ...
                <div class="d-flex justify-content-center align-items-center py-2">
                  ...
                  <input class="register-input" placeholder="Your e-mail" type="email" />
                </div>
                ...
                <div class="d-flex justify-content-center align-items-center py-2">
                  ...
                  <input class="register-input" placeholder="Password" type="text" />
                </div>
                <div class="d-flex justify-content-center align-items-center">
                  <div class="d-xl-flex align-items-center">
                    <label class="checkbox-input text-left">
